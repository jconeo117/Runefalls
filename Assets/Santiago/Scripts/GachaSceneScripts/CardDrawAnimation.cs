...
/// <summary>
/// CardDrawAnimation — animación del draw de cartas en la gacha.
/// Audio: adjuntar A_CardDrawAudio al mismo GameObject para configurar los sonidos.
/// </summary>
public class CardDrawAnimation : MonoBehaviour
{
    ...
    private A_CardDrawAudio _audio;
    ...
    void Start()
    {
        _audio = GetComponent<A_CardDrawAudio>();
    ...
    IEnumerator RunDraw()
    {
        ...
        for (int i = 0; i < totalSteps; i++)
        {
            ...
            _audio?.OnShuffleTick(i, totalSteps);
