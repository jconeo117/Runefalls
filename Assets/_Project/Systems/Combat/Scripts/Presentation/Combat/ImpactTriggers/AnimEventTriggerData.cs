...
namespace Runefall.Presentation.Combat
{
    ...
    public class AnimEventTriggerData : ImpactTriggerData
    {
        ...
        {
            int   hits        = expectedHits > 0 ? expectedHits : CountExpectedHits(allClips, eventName);
            float safetyDelay = ComputeSafetyDelay(allClips, fallbackDelay);
            return new AnimEventTrigger(caster, host, hits, safetyDelay);
        }
    ...
    public sealed class AnimEventTrigger : IImpactTrigger
    {
        ...
        private void Complete()
        {
            ...
            // Safety timer may still fire after Complete — HasFired guard above handles it.
        }
    }
}
